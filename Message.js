...
module.exports = {
    sendPM: function (res, req, senderID, receipentID, content) {
        //Send private message to another user by inserting record into DB.
    ...
    retrievePM: function (res, req, count) {
        ...
        //including getting user name given userid.
        //because we have to do multiple SQL, we have to use async to keep avoiding callback hell.
